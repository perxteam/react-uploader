  ...
  function Uploader() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Uploader.__proto__ || Object.getPrototypeOf(Uploader)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return function (response) {
        return response.json().then(function (data) {
          if (data.result === 'success') {
            ...
            var totalFilesSizeLimit = _this.props.totalFilesSizeLimit;
      ...
      var _this$props2 = _this.props,
          apiUrl = _this$props2.apiUrl,
          onChangeFilesSelection = _this$props2.onChangeFilesSelection,
          method = _this$props2.method,
          headers = _this$props2.headers,
          fetchConfig = _this$props2.fetchConfig,
          totalFilesCount = _this$props2.totalFilesCount,
          totalFilesCountError = _this$props2.totalFilesCountError,
          fileSizeMin = _this$props2.fileSizeMin,
          fileSizeMinError = _this$props2.fileSizeMinError,
          fileSizeMax = _this$props2.fileSizeMax,
          fileSizeMaxError = _this$props2.fileSizeMaxError,
          totalFilesSizeLimit = _this$props2.totalFilesSizeLimit,
          totalFilesSizeLimitError = _this$props2.totalFilesSizeLimitError,
          fileExtensions = _this$props2.fileExtensions,
          fileExtensionsError = _this$props2.fileExtensionsError;
  ...
  _createClass(Uploader, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        showFilesList && _react2.default.createElement(
          'div',
          { className: 'files-uploader__files-list' },
          files.map(function (file) {
            return _react2.default.createElement(
              'div',
              { className: 'files-uploader-files-list__item', key: file.id },
              _react2.default.createElement(
                'span',
        ...
        showErrorsList && errors && Object.keys(errors).length ? _react2.default.createElement(
          'div',
          { className: 'files-uploader__errors' },
