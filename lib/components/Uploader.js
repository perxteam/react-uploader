...
}, _defineProperty(_Uploader$propTypes, 'showErrorsList', _propTypes2.default.bool), _defineProperty(_Uploader$propTypes, 'trailingSlash', _propTypes2.default.bool), _defineProperty(_Uploader$propTypes, 'actualDelete', _propTypes2.default.bool), _defineProperty(_Uploader$propTypes, 'filenameField', _propTypes2.default.string), _defineProperty(_Uploader$propTypes, 'totalFilesCount', _propTypes2.default.number), _defineProperty(_Uploader$propTypes, 'totalFilesCountError', _propTypes2.default.string), _defineProperty(_Uploader$propTypes, 'fileSizeMin', _propTypes2.default.number), _defineProperty(_Uploader$propTypes, 'fileSizeMinError', _propTypes2.default.string), _defineProperty(_Uploader$propTypes, 'fileSizeMax', _propTypes2.default.number), _defineProperty(_Uploader$propTypes, 'fileSizeMaxError', _propTypes2.default.string), _defineProperty(_Uploader$propTypes, 'totalFilesSizeLimit', _propTypes2.default.number), _defineProperty(_Uploader$propTypes, 'totalFilesSizeLimitError', _propTypes2.default.string), _defineProperty(_Uploader$propTypes, 'fileExtensions', _propTypes2.default.string), _defineProperty(_Uploader$propTypes, 'fileExtensionsError', _propTypes2.default.string), _defineProperty(_Uploader$propTypes, 'hint', _propTypes2.default.string), _Uploader$propTypes);
